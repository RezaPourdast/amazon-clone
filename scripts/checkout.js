...
cart.forEach((cartItem) => {
  ...
  productSummaryHtml += `<div class="cart-item-container js-container-id-${
    matchingProduct.id
            ...
            <div class="delivery-date">Delivery date: Tuesday, February 14</div>
            ...
            <div class="cart-item-details-grid">
              ...
              <div class="delivery-options">
                ...
                <div class="delivery-option">
                  ...
                  />
                  <div>
                    <div class="delivery-option-date">Tuesday, February 14</div>
                ...
                <div class="delivery-option">
                  ...
                  />
                  <div>
                    <div class="delivery-option-date">Monday, February 9</div>
